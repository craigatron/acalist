...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.latitude'
        db.alter_column(u'groups_group', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Group.longitude'
        db.alter_column(u'groups_group', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Group.latitude'
        raise RuntimeError("Cannot reverse this migration. 'Group.latitude' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Group.latitude'
        db.alter_column(u'groups_group', 'latitude', self.gf('django.db.models.fields.FloatField')())

        # User chose to not deal with backwards NULL issues for 'Group.longitude'
        raise RuntimeError("Cannot reverse this migration. 'Group.longitude' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Group.longitude'
        db.alter_column(u'groups_group', 'longitude', self.gf('django.db.models.fields.FloatField')())
