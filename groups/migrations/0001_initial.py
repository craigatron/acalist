...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'groups_group', (
            ...
            ('group_type', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('wikipella_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('facebook_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('twitter_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('youtube_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('gplus_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('myspace_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('makeup', self.gf('django.db.models.fields.IntegerField')()),
            ('is_auditioning', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
    ...
    models = {
        u'groups.group': {
            ...
            'wikipella_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
